      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-blue-800 text-white py-12 sm:py-20">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">BIT Mesra Complaint System</h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
              <Link 
                to="/student-login" 
                className="bg-white text-blue-800 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition"
              >
                Student Login
              </Link>
              <Link 
                to="/authority-login" 
                className="bg-transparent border-2 border-white text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-800 transition"
              >
                Authority Login
              </Link>
            </div>
